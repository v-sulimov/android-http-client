 ...
 * @property maxRedirects The maximum number of consecutive redirects the client will follow before
 * aborting with a [RedirectException]. Prevents infinite redirect loops. Only meaningful when
 * [followRedirects] is `true`. Default: 10.
 */
class HttpClientConfiguration private constructor(
    ...
    class Builder {
        ...
        /**
         * Sets the maximum number of consecutive redirects the client will follow before aborting.
         *
         * When the redirect chain exceeds this limit, the request fails with a [RedirectException].
         * This setting has no effect when [setFollowRedirects] is `false`.
         *
         * @param maxRedirects Maximum redirect hops (must be non-negative).
         * @return This [Builder] for chaining.
         * @throws IllegalArgumentException If [maxRedirects] is negative.
         */
        fun setMaxRedirects(maxRedirects: Int) = apply {
            require(maxRedirects >= 0) { "Max redirects must be non-negative" }
         ...
         */
        fun build() = HttpClientConfiguration(
            readTimeout,
            connectTimeout,
    ...
    /**
     * Returns a [Builder] pre-populated with this configuration's current settings.
     *
     * Use this to create a modified copy of an existing configuration without repeating unchanged values.
     *
     * **Example:**
     * ```kotlin
     * val base = HttpClientConfiguration.builder().setReadTimeout(5000).build()
     * val longer = base.toBuilder().setReadTimeout(30000).build()
     * ```
     *
    ...
    fun toBuilder(): Builder = Builder()
        ...
        .setCertificateInputStream(certificateInputStream)
