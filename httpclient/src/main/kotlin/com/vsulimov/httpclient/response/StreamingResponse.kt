 ...
 * @param headers A [Map] of HTTP response header names to their values. Header values with multiple
 * entries are joined with commas. The HTTP status-line pseudo-header is excluded.
