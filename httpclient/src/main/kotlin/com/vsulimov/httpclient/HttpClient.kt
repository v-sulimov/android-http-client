...
class HttpClient(
     ...
     */
    fun executeGetRequest(request: GetRequest): Result<Response> {
     ...
     * @return A [Result] containing either a [Response] on success or an exception on failure.
     */
    fun executePostRequest(request: PostRequest): Result<Response> {
        return executeRequest(request)
    }
     ...
     * @return A [Result] containing either a [Response] on success or an exception on failure.
     */
    fun executePutRequest(request: PutRequest): Result<Response> {
        return executeRequest(request)
    }
     ...
     * @return A [Result] containing either a [Response] on success or an exception on failure.
     */
    fun executeDeleteRequest(request: DeleteRequest): Result<Response> {
        return executeRequest(request)
    }
     ...
     * @return A [Result] containing either a [Response] on success or an exception on failure.
     */
    fun executeHeadRequest(request: HeadRequest): Result<Response> {
        return executeRequest(request)
    }
     ...
     * @return A [Result] containing either a [Response] on success or an exception on failure.
     */
    fun executeOptionsRequest(request: OptionsRequest): Result<Response> {
        return executeRequest(request)
    }
     ...
     * @return A [Result] containing either a [Response] on success or an exception on failure.
     */
    fun executePatchRequest(request: PatchRequest): Result<Response> {
        return executeRequest(request)
    }
